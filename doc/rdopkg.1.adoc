...
You can skip this with `-l`/`--local-patches` to directly use local
...
You can override this using `-R`/`--release-bump-strategy` argument which
expects integer index of release part to bump, starting at 1:
