...
You can use the `-N` or `-n` options to control whether `new-version` will
upload sources to dist-git. By default, rdopkg will automatically enable or
disable this step based on the dist-git branch name. RHOS-named branches
