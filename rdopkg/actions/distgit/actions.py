...
def get_package_env(version=None, release=None, dist=None, branch=None,
    ...
    if release_bump_strategy is None:
        args['release_bump_strategy'] = guess.release_bump_strategy()
...
def show_package_env(package, version,
    ...
    _putv('Release bump: ', release_bump_strategy)
...
def update_spec(branch=None, changes=None,
                ...
                changelog_email=None, release_bump_strategy=None):
    ...
    if new_release is not None:
        ...
        spec.bump_release(milestone=new_milestone,
                          strategy=release_bump_strategy)
    if new_patches_base:
