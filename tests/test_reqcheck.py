...
def test_reqcheck_overridden_nothing_1(tmpdir, capsys):
    dist_path = common.prep_spec_test(tmpdir, 'reqcheck-overridden')
    with dist_path.as_cwd():
...
def test_reqcheck_overridden_ignore_1(tmpdir, capsys):
    dist_path = common.prep_spec_test(tmpdir, 'reqcheck-overridden')
    with dist_path.as_cwd():
...
def test_reqcheck_overridden_ignore_2(tmpdir, capsys):
    dist_path = common.prep_spec_test(tmpdir, 'reqcheck-overridden')
    with dist_path.as_cwd():
